...
> 普攻当前版本为 [ATTACK_V4](MINOTAUR_BREAKER_ATTACK_V4.md)：更高蓄力、斧刃触地重劈与程序化冲击特效，2.3 秒；技能当前版本为 [CHARGE_V5](MINOTAUR_BREAKER_CHARGE_V5.md)：持斧臂前伸直立携斧、56 度深俯身牛角冲锋，4.2 秒。新预览在 `reports/minotaur_breaker/actions_v4/`；本文件中的V1帧图和压力数据作为历史记录保留。
