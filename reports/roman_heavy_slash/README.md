...
Native changes: slight rear preload, raised sword, pelvis/torso drive, forward/down slash and controlled recovery. Both knees now flex forward; reduced hip descent avoids mirrored deep squat. This version keeps both soles planted instead of reproducing the reference heel lift. Hit method event occurs once at 0.52s; duration 1.20s. Other four animations, skeleton, knee plate, materials and parts are unchanged.
