...
def build_skill(m):
    ...
    for t in times:
        p=m.base();context=f'skill_v5:{t:.3f}'
        ...
        grip_x=float(m.lerp_keys(t,[(0,[778]),(.18,[830]),(.42,[880]),(.60,[900]),(3.48,[900]),(3.95,[830]),(4.2,[778])])[0])
        grip_y=float(m.lerp_keys(t,[(0,[850]),(.18,[855]),(.42,[858]),(.60,[860]),(3.48,[860]),(3.95,[855]),(4.2,[850])])[0])
