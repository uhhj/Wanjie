...
def main():
    ...
    if 'walk_chain_review' in g:
        lines+=['','当前 Walk 修正了小腿与脚掌联动：屈膝提前到蹬地阶段，收小踝部单独折动。自然度仍待用户观看新版确认。[16帧跟随视角](walk_chain_v2/walk_reference_follow_256.gif) / [本次报告](WALK_CHAIN_COUPLING_V2.md)。']
    ...
    if any(k in g for k in ['walk_keyframe_polish','walk_reference_review','walk_chain_review']):
