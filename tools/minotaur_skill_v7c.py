...
def build_skill(m):
    ...
    for t in times:
        p=m.base();context=f'skill_v7c:{t:.3f}'
        ...
        grip_x=float(m.lerp_keys(t,[(0,[778]),(.30,[815]),(.70,[855]),(1.10,[865]),(3.48,[865]),(3.95,[820]),(4.2,[778])])[0])
        grip_y=float(m.lerp_keys(t,[(0,[850]),(.30,[905]),(.70,[975]),(1.10,[1000]),(3.48,[1000]),(3.95,[905]),(4.2,[850])])[0])
        ...
        hand_orient=phi+130.*envelope+sway*float(envelope>0)
