...
const FOLDER := "res://reports/minotaur_breaker/attack_v3/frames"
const NAMES := ["attack_01"]
...
func run() -> void:
	...
	var prior_path:="res://reports/minotaur_breaker/attack_v3_capture_manifest.json"
	...
	var f := FileAccess.open("res://reports/minotaur_breaker/attack_v3_capture_manifest.json",FileAccess.WRITE)
