...
func run() -> void:
	...
	var prior_path:="res://reports/minotaur_breaker/actions_v4_capture_manifest.json"
	...
	var f := FileAccess.open("res://reports/minotaur_breaker/actions_v4_capture_manifest.json",FileAccess.WRITE)
